...
var e=!("undefined"==typeof window&&"undefined"==typeof self),n="undefined"==typeof requestIdleCallback?function(e){return setTimeout(e,0)}:requestIdleCallback;function getPersistMiddleware(t){var u=t.cacheFn,r=t.actionMap,o=t.logger;return function(t){var i=t.getState;return function(t){return function(a){var f=r[a.type],c=t(a),d=i();return e&&f&&n(function(){Promise.all(f.map(function(e){return u(e,d[e])})).then(function(){o&&o("cached "+f.join(", ")+" due to "+a.type);});},{timeout:500}),c}}}}
